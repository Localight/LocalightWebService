...
describe('Giftcard Model Unit Tests:', function() {
   ...
   beforeEach(function(done) {
      ...
      giftcard = new Giftcard({
         ...
         giftSenderFirstName: user.firstName,
         amount: 1000,
         mobileNumberOfSender: 5456541234, // make sure it's someone else.
         mobileNumberOfRecipient: 1234567890,

         message: 'A gift for you!',
         emailForReceipt: user.email,
   ...
   describe('Method Save', function() {
      ...
      it('should show an error when trying to save without an amount', function(done) {
         giftcard.amount = '';
         return giftcard.save(function(err) {
            should.exist(err);
            done();
      ...
      it('should show an error when trying to save withouth a Mobile Number entered.', function(done) {
      ...
      it('should show an error whenever anyting other than intergers have been added into the mobile number', function(done) {
      ...
      it('should show an error whenever trying to save a name with less that 3 characters', function(done) {
         giftcard.giftSenderFirstName = 'ad';
         return giftcard.save(function(err) {
            should.exist(err);
            done();
         });
      ...
      it('should show an error whenever anything other than intergers have been added into the amounts', function(done) {
      ...
      //TODO: test to reject negative numbers too.

      it('should show an error whenever anything other than numbers into the  mobileNumberOfRecipient property.', function(done) {
         giftcard.mobileNumberOfRecipient = '2342342334a';
         return giftcard.save(function(err) {
            should.exist(err);
            done();
         });
      ...
      it('should show an error whenever the length is not correct.', function(done) {
         giftcard.mobileNumberOfRecipient = '23';
         return giftcard.save(function(err) {
            should.exist(err);
            done();
         });
      ...
      it('should show an error whenever saving incorrect email format', function(done) {
         giftcard.emailForReceipt = 'asdfsdaf';
         return giftcard.save(function(err) {
            should.exist(err);
            done();
         });
