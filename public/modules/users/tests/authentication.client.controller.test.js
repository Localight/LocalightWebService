...
// 			$httpBackend.when('POST', '/api/authsignin').respond(200, 'Fred');
//
// 			scope.signin();
// 			$httpBackend.flush();
//
...
// 			$httpBackend.expectPOST('/api/authsignin').respond(400, {
...
// 			$httpBackend.when('POST', '/api/authsignup').respond(200, 'Fred');
//
// 			scope.signup();
// 			$httpBackend.flush();
//
...
// 			// Test expected POST request
// 			$httpBackend.when('POST', '/api/authsignup').respond(400, {
