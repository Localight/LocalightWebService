...
// 			$httpBackend.when('POST', '/authsignin').respond(200, 'Fred');
//
// 			scope.signin();
// 			$httpBackend.flush();
//
...
// 			$httpBackend.expectPOST('/authsignin').respond(400, {
...
// 			$httpBackend.when('POST', '/authsignup').respond(200, 'Fred');
//
// 			scope.signup();
// 			$httpBackend.flush();
//
...
// 			// Test expected POST request
// 			$httpBackend.when('POST', '/authsignup').respond(400, {
